...
CED_decoder <-
  ...
  .[, .SD, .SDcols =  c("CED_CODE_2016", "Electoral_division")]
```
...
CED__HomeCensusNight <-
  ...
  .[, .SD, .SDcols = c("CED_CODE_2016", "HomeCensusNight", "persons")] %>%
  setorderv(setdiff(names(.), "persons")) %>%
  set_cols_last("persons") %>%
  .[]
```
...
CED__HomeCensusNight_Sex <-
  ...
  .[, .SD, .SDcols = c("CED_CODE_2016", "HomeCensusNight", "Sex", "persons")] %>%
  setorderv(setdiff(names(.), "persons")) %>%
  set_cols_last("persons") %>%
  .[]
```
...
CED__UsualResidence_Age <-
  ...
  .[, .SD, .SDcols = c("CED_CODE_2016", "Age", "UsualResidence", "persons")] %>%
  setkeyv(c("CED_CODE_2016", "Age", "UsualResidence")) %>%
  .[]
```
